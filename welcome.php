...
<section class="welcome-section">
    <h2 class="scoreboard-title">
        <?php
        if (isset($_SESSION['Name'])) { // Ensure this matches the session variable you set upon login.
            echo "Welcome back, " . htmlspecialchars($_SESSION['Name']) . "! Your journey continues here. Enjoy!";
        } else {
            echo "Welcome! Your journey starts here.";
        }
        ?>
    </h2>
